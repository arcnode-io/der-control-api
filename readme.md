...
![](https://img.shields.io/gitlab/pipeline-status/arcnode-io/der-control-api?branch=main&logo=gitlab)
![](https://gitlab.com/arcnode-io/der-control-api/badges/main/coverage.svg)
